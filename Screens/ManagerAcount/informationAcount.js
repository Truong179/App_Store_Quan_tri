...
const InformationAcount = (props) => {
    ...
    return (
        <View style={{ flex: 1, alignItems: 'center' }}>
            <View style={{ height: 189, width: 330, backgroundColor: Colors.wwhite, marginTop: 50, padding: 20, borderRadius: 10 }}>
                <View style={{ marginBottom: 10 }}>
                    <Text style={styles.textTitle}>Email</Text>
                    <Text style={styles.textItem}>vanhung@gmail.com</Text>
                </View>
                <Image style={{ marginTop: 9 }} source={require('../../Image/line.png')} />
