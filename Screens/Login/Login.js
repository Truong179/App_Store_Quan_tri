    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.body}>
                ...
                {errorUserName && <Text style={{ color: "red", marginTop: 5, marginStart: 10 }}>{errorUserName}</Text>}
                <TextInput
                    onChangeText={(text) => {
                        if (text.length > 0) {
                ...
                {errorPassword && <Text style={{ color: "red", marginTop: 5, marginStart: 10 }}>{errorPassword}</Text>}
...
const styles = StyleSheet.create({
    btnLogin: {
        ...
        height: 40, marginTop: 20, justifyContent: "center", alignItems: "center",
        borderRadius: 10
    },
    textInput: {
        backgroundColor: "rgba(248, 248, 248, 1)",
        height: 45, borderRadius: 10, paddingStart: 15, marginTop: 20
    },
    body: {
        height: '40%', backgroundColor: "white", marginTop: 5, paddingHorizontal: 20
