...
const Home = () => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.statistical}>
                <View style={styles.statisticalDay}>
                    ...
                    <View style={{ alignItems: "center" }}>
                        ...
                        <TouchableOpacity style={
                            ...
                            <Text style={{ fontSize: 12, fontWeight: "bold" }}>Xem chi tiết </Text>
                            <Image style={{
                                width: 17, height: 17
                ...
                <View style={styles.statisticsOrder}>
                    <View style={{
                        ...
                        height: 68, borderRightWidth: 0.5, borderColor: "gray"
                    }}>
                        <Text>Đơn hàng</Text>
                    ...
                    renderItem={({ item }) => {
                        return (
                            <TouchableOpacity style={{
                                ...
                                <View style={{
                                    width: 60, height: 60, borderRadius: 30, backgroundColor: item.color,
                                    marginTop: 20, marginRight: 29, justifyContent: "center", alignItems: "center"
                                }}>
                                    <Image style={{
                                        width: 30, height: 30
                                    }} source={item.image} />
            ...
            }}>Đơn hàng đang xử lý</Text>

            <View style={{
                width: "100%", height: 180, borderRadius: 5,
                marginTop: 20, backgroundColor: "white", elevation: 8, padding: 10
            }}>

                <TouchableOpacity style={{
                    flexDirection: "row", marginTop: 10
                    , justifyContent: "space-between", borderBottomWidth: 0.4, paddingBottom: 15,
                    borderColor: "gray"
                }}>
