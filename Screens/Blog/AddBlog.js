            ...
            <View>
                <Modal visible={showDialog}
                    ...
                    <View style={{ backgroundColor: Colors.wwhite, width: "80%", alignSelf: 'center', height: "80%" }}>
                        ...
                        <Text style={{ textAlign: 'center', marginTop: 15, fontSize: 24, fontWeight: 'bold', color: Colors.black }}>Add blog</Text>
                        <View style={{ margin: 10 }}>
                            ...
                            <Image style={{width:200,height:200,backgroundColor:Colors.gray,alignSelf:'center'}}/>
                ...
                >
                    <Image style={{ height: 30, width: 30, alignSelf: 'flex-end', marginRight: 20 }} source={{ uri: "https://cdn-icons-png.flaticon.com/512/262/262038.png" }} />
