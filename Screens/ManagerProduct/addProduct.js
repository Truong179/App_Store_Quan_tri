    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.body}>
                <View style={{
                    marginTop: 10, height: 70, backgroundColor: "white",
                ...
                <View style={{
                    ...
                    paddingHorizontal: 20, paddingVertical: 10, flex: 1
                }}>
                    <View style={{
                        flexDirection: "row",
                    ...
                    <View style={{
                        flexDirection: "row", paddingVertical: 10, marginTop: 6,
                        justifyContent: "space-between", borderBottomWidth: 1, borderColor: "#EEEEEE"
                    }}>
                        <Text>Giá bán</Text>
                        <TextInput
